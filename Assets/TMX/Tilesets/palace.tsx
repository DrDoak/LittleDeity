...
<tileset name="palace" tilewidth="32" tileheight="32" tilecount="100" columns="10">
 <image source="../../Art/Tiles/palace.png" width="320" height="320"/>
 <terraintypes>
  <terrain name="tiled" tile="0"/>
  <terrain name="stone" tile="0"/>
  <terrain name="bkg" tile="0"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
